...
class Specification(object):
    ...
    :func:`~asn1.compile_files()`,
    :func:`~asn1.compile_string()` and
    :func:`~asn1.compile_dict()`.
...
def compile_dict(specification,
    ...
    :class:`~asn1.compiler.Specification` object that can be used
    ...
    >>> foo = asn1.compile_dict(asn1.parse_files('foo.asn'))
...
def compile_string(string,
    ...
    ...     foo = asn1.compile_string(fin.read())
...
def compile_files(filenames,
    ...
    >>> foo = asn1.compile_files('foo.asn')

    Give `cache_dir` as a string to use a cache.

    >>> foo = asn1.compile_files('foo.asn', cache_dir='my_cache')
